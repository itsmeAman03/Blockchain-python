...
def test_is_valid_chain_bad_block(blockchain_three_block):
    blockchain_three_block.chain[0].hash='malicious_hash'
...
def test_replace_chain_bad_chain(blockchain_three_block):
    blockchain=Blockchain()
    blockchain_three_block.chain[1].hash= 'malicious_hash'
